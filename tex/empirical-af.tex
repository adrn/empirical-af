...
For example, the orbits in the left panel of Figure~\ref{fig:mgfe-zvz} start as
horizontal ellipses for the lowest values of \zmax\ and transition to vertical ellipses
for the largest values of \zmax.
...
1~\kpc$ in Figure~\ref{fig:mgfe-zvz}).
Orbits with $z_{\textrm{max}} \gtrsim 1~\kpc$ feel deform from ellipses to more
...
\citep[e.g.,][]{Ness:2019}, so the different moments and/or abundances must be
incorporated conditionally \citep[e.g.,][]{Ratcliffe:2023}.
We will explore this in future work.


\section{Summary and Conclusions} \label{sec:conclusions}

We introduce a new definition and implementation of the Orbit Torus Imaging (OTI)
framework, a novel approach for inferring the orbital structure of stellar populations
and characterizing the underlying gravitational field using stellar labels.
...
It is a pleasure to thank Neige Frankel, Melissa Ness, Scott Tremaine, Julianne
Dalcanton, and the \textit{Nearby Universe Group} at the CCA for useful discussions and
