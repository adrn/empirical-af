...
Measurements of all six dimensions of phase-space co- ordinates of tens of millions of
stars in the Milky Way have enabled estimates of their orbital properties. The meaning
of these estimates is limited by the measurement errors, our knowledge of the Galactic
potential and the validity of the assumptions necessary to derive orbital properties in
the first place (eg. a static, axisymmetric mass distribution). Price-Whelan et al
showed how 6-D phase-space mea- surements of stars in the Galactic disk allow us to see
orbital tori images (OTI) projected as isopleths and iso-abundance contours in the Z--vZ
plane. This promises the opportunity to gain potential- independent knowledge of orbital
properties, mitigating one of these limitations. This paper explores to what extent
these OTI can be used to estimate fundamental orbital properties of stars — actions,
frequencies and angles — directly from these contours. Estimates are made by contouring
projections of simulated data drawn from a static, equilibrium axisymmetric galaxy
model. Compared to the true orbital properties calculated in the known potential of the
realization the estimates are found to ....??? For a snapshot of a simulation of a
Milky-Way-like Galaxy perturbed by a massive, infalling satellite, the estimates
????Applying our method to the Gaia DR3 data.... We conclude
