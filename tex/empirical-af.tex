...
These surveys have enabled new views of the Milky Way that extend far beyond the solar neighborhood.
...
\citealt{WEAVE:2023}, 4MOST \citealt{deJong:2019}, Rubin/LSST \citealt{LSST:2009}, and SDSS-V \citealt{Kollmeier:2017}).
...
This is a typical assumption for near-circular orbits in an axisymmetric potential, such as for stellar populations within the Galactic disk.
...
The vertical action scales approximately with $J_z \approx \frac{1}{2} \Omega_z \, \zmax^2$.
