...
\author[0000-0003-1856-2151]{Daniel~Horta~Darrington}
\affiliation{\affcca}
...
distribution near the Galactic disk and to study out-of-equilibrium dynamics (e.g., the
\gaia\ spiral).
...
These orbits can be used to directly infer a mass model for the Milky Way, enabling
constraints on the dark matter distribution in the inner galaxy.
...
orbit foliation.
We show that this framework --- ``Orbital Torus Imaging'' (OTI) --- does a good job of
fitting orbits to simulated stellar abundance data with varying degrees of realism.
Importantly, OTI (1) does not require a global model for the Milky Way mass
distribution, and (2) does not require detailed modeling of the selection function of
the input survey data.
...
measurements of intrinsically-invariant stellar labels, such as stellar surface element
...
For element abundances, this is nearly true for surveys like \apogee, where the primary
